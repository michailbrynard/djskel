...
BASE_DIR=/home/webapps/Projects/ngkdb
...
GUNICORN_CONFIG_FILE=/home/webapps/Projects/ngkdb/etc/gunicorn.conf.py

# Activate the virtual environment
cd $APP_DIR
source /home/webapps/Virtualenvs/ngkdb/bin/activate
