...
sudo mkdir /var/lib/awstats/{{ project_url }}/
sudo chown -R webapps:webapps /var/lib/awstats/
# sudo chmod -R 755 /var/lib/awstats/

sudo chown -R webapps:webapps /var/log/nginx

# sudo /usr/share/awstats/tools/awstats_buildstaticpages.pl -config={{ project_url }} -dir=/var/www/awstats/ -staticlinks -awstatsprog=/usr/lib/cgi-bin/awstats.pl
