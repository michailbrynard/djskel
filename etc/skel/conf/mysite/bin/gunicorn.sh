...
BASE_DIR=/home/webapps/Projects/mysite 
...
GUNICORN_CONFIG_FILE=/home/webapps/Projects/mysite /etc/gunicorn.conf.py

# Activate the virtual environment
cd $APP_DIR
source /home/webapps/Virtualenvs/mysite /bin/activate
