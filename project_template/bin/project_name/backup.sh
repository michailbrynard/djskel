...
project_dir=/home/webapps/Projects/{{ project_name }}/
...
link="http://{{ project_domain }}/media/backups/${file_name}"
...
echo -e '\n'
echo "SCP command:"
echo "scp {{ server_user }}@{{ server_host }}:/home/webapps/backups/${file_name} backup.zip"
